    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="w-80 bg-white shadow-lg rounded-lg p-6">
        ...
        <div className="flex flex-col gap-4 mt-6">
          ...
          <button onClick={handleGoogleLogin} className="flex items-center justify-center gap-2 rounded-full bg-white text-black py-3 border-2 border-gray-400 shadow-md cursor-pointer hover:bg-gray-100">
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth={0}
